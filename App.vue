...
button,image,label,navigator,swiper,textarea,view {
...
.nav-li.cur .nav-li-2.cur {
	color: #fff;
	background: #5eb95e;
	box-shadow: 4rpx 4rpx 6rpx rgba(94,185,94,.4);
}
.nav-title {
	font-size: 32rpx;
	font-weight: 300;
...
.nav-name:after,.nav-name:before {
	content: "";
	position: absolute;
	display: block;
	background: #fff;
